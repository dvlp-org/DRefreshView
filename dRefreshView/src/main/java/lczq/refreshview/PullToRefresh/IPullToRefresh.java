...
public interface IPullToRefresh<T extends View> {
     ...
     * 设置刷新动画的监听器（目前只有下拉）
     *
     * @param mRefreshAnimationListener 监听器对象
     */
    public void setOnRefreshAnimationListener(PullToRefreshBase.OnRefreshAnimationListener<T> mRefreshAnimationListener);
